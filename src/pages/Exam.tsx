...
import { getQuestionCountBySubject } from "@/utils/questionBank";
...
const Exam = () => {
  ...
  const handleGenerateExam = () => {
    ...
    try {
      ...
      const availableQuestionCount = getQuestionCountBySubject(selectedSubject);
      
      if (availableQuestionCount === 0) {
        throw new Error(`No questions available for ${selectedSubjectObj?.name}. Please select another subject.`);
      }
      
      // Generate questions using our offline generator
      ...
      if (result.warning) {
        ...
        toast({
          title: "Exam Ready",
          description: `${result.questions.length} questions have been prepared for your exam. Good luck!`
        });
      }
            ...
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <p className="max-w-[700px] text-muted-foreground md:text-lg">
                  Test your knowledge with questions from our offline question bank.
                  Each exam creates a unique set of questions selected specifically for your chosen subject.
                </p>
              </div>
